...
void loop(){
  ...
  myservo.write(75); //Servo na posiçao 90 (Frente)
  delay(200);
  ...
  if(distancia <= 24){ // Se a distancia do obstaculo for menor ou igual
    ...
    delay(500); // Espera 350 microsegundos
    digitalWrite(pinBuzzer,LOW);//Desliga o Buzzer
    motorFreio(); // Robô para
    delay(500);
    myservo.write(165); // Servo motor vai para a posição 0 (Esquerda)
    delay(750); // Espera 10 microsegundos
...
void motorFrente(){
    ...
    analogWrite(velocidadeA,140); // Velocidade em 100/255
    digitalWrite(IN3, LOW);
    digitalWrite(IN4, HIGH);
    analogWrite(velocidadeB,130); // Velocidade em 100/255
...
void motorRe(){
    ...
    analogWrite(velocidadeA,160); // Velocidade em 100/255
    digitalWrite(IN3, HIGH);
    digitalWrite(IN4, LOW);
    analogWrite(velocidadeB,160); // Velocidade em 100/255
